			...
			switch (options[rand(options.length)]){
						...
						if (weapons.indexOf(a) != -1 || melee.indexOf(a) != -1){
							...
							if (a === "melee" && fate === 0){
								...
								if (b === "random mine"){
									...
									if (c === 0){
										...
										if (s != q){
											...
											fates.push(allNames[r] + " drops a lego that kills " + allNames[q] + ".");
											xKillsY(r,q);
											done[q] = true;
										}
									}
									else {
										fates.push(allNames[r] + " accidentally steps on " + proPos[r] + " a lego.");
										xDies(r);
									}
								}
								else if (a === "frisbee"){
								...
								if (a === "frisbee"){
									...
									injureTwo(r,q);
									if (!deathBools[q]){
										fates.push(allNames[r] + " hugs " + allNames[q] + " with " + proPos[r] + " a tank.");
										done[q] = true;
										summary.push(fates[fates.length-1]);
									}
									else {
				...
				case "shelter":
					...
					if (b === 0){
						...
						fates[fates.length-1] += ", but decides he needs a fidget spinner in order to survive.";
					}
					break;
				case "misc":
				...
				case "death":
					...
					if (a === "breaks"){
						...
						fates.push(allNames[r] + " dies because of " + allNames[q] + "\'s mario kart character.");
						summary.push(fates[fates.length-1]);
						xKillsY(q,r);
					}
					else if (a === "hangs"){
						...
						fates.push(allNames[r] + " gets beat to d*ath by " + proPos[r] + " mother\'s coat hanger.");
						xDies(r);
						summary.push(fates[fates.length-1]);
					}
					else if (a === "stream"){
						fates.push(allNames[r] + " said racial slurs on a Twitch livestream and got roasted to d*ath.")
					}
						...
						if (lol != -1 || lol2 != -1){
							...
							fates.push(allNames[r] + " and " + allNames[q] + " dies of AIDS.");
							deathBools[r] = false;
							deathBools[q] = false;
							done[q] = true;
							summary.push(fates[fates.length-1]);
